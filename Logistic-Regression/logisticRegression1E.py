...
# test
#####################################################################################################
lr.logistic_reg_test(model_weights, 1.5)
lr.logistic_reg_test(model_weights, 2.5)
lr.logistic_reg_test(model_weights, 3.5)
lr.logistic_reg_test(model_weights, 4.5)
lr.logistic_reg_test(model_weights, 5.5)
lr.logistic_reg_test(model_weights, 6.5)
lr.logistic_reg_test(model_weights, 7.5)
